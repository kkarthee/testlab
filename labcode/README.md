...
2. [Setup - The basics of getting started with labcode](#setup)
    * [What labcode affects](#what-labcode-affects)
    * [Setup requirements](#setup-requirements)
    * [Beginning with labcode](#beginning-with-labcode)
